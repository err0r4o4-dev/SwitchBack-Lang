...
public sealed class LocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Subtitle"] = "Fix text typed in the wrong language.",
        ["Status"] = "Status",
        ["LanguagesTitle"] = "Keyboard languages",
        ["LanguagesHint"] = "Choose the two languages you switch between.",
        ["FirstLanguage"] = "First language",
        ["SecondLanguage"] = "Second language",
        ["Shortcut"] = "Shortcut",
        ["Advanced"] = "Advanced settings",
        ["EnableConversion"] = "Enable global text conversion",
        ["UsageHint"] = "Select text, switch Windows to the intended language, then press the shortcut.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Thai = new Dictionary<string, string>
    {
        ...
        ["Subtitle"] = "แก้ข้อความที่พิมพ์ผิดภาษา",
        ["Status"] = "สถานะ",
        ["LanguagesTitle"] = "ภาษาคีย์บอร์ด",
        ["LanguagesHint"] = "เลือกสองภาษาที่คุณสลับใช้",
        ["FirstLanguage"] = "ภาษาที่หนึ่ง",
        ["SecondLanguage"] = "ภาษาที่สอง",
        ["Shortcut"] = "ปุ่มลัด",
        ["Advanced"] = "การตั้งค่าขั้นสูง",
        ["EnableConversion"] = "เปิดใช้งานการแปลงข้อความทั่ว Windows",
        ["UsageHint"] = "คลุมข้อความ เปลี่ยนภาษา Windows แล้วกดปุ่มลัด",
        ...
        ["SaveSettings"] = "นำไปใช้",
        ["SettingsSaved"] = "นำการตั้งค่าไปใช้แล้ว",
        ["Settings"] = "ตั้งค่า",
        ["Enabled"] = "เปิดใช้งาน",
        ["Exit"] = "ออก",
